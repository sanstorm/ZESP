...
Blockly.FieldOID.prototype.setValue = function(id) {
	...
	var text=id;
/*    var objects = workspaceBlocks.objects;
...
Blockly.FieldOID.prototype.showEditor_ = function(opt_quietInput) {
    ...
    var that = this;
	console.log(Blockly.WorkspaceSvg.id)

//selId();
	
 	
  //  window.main && window.main.selectIdDialog && window.main.
  selectIdDialog(this.getValue(), function (newId){ that.setValue(newId);});
